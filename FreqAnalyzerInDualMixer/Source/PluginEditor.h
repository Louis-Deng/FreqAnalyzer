...
/**
*/
class FreqAnalyzerInDualMixerAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    FreqAnalyzerInDualMixerAudioProcessorEditor (FreqAnalyzerInDualMixerAudioProcessor&);
